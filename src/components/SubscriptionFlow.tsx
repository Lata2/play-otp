      ...
      <div className="mx-auto flex max-w-md flex-col gap-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="flex flex-wrap gap-1 text-sm">
            Play is a subscription service that will automatically renew for AED
            3.25/Daily for Etisalat subscribers until you unsubscribe. You can
            unsubscribe from the service at anytime, by sending C HP1 to 1111.
          </div>
        </div>

        {/* Disclaimer */}
        <p className="text-center text-xs leading-relaxed text-slate-400">
          Play is a subscription service of Etisalat UAE that automatically
