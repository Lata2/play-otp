    ...
    <div className="min-h-screen bg-[#F6F8FB] px-4 py-10">
      <div className="mx-auto flex max-w-md flex-col gap-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-2 text-base text-center font-semibold text-slate-900">Terms and Conditions</h2>
          
          <div className="flex flex-wrap gap-1 text-sm">
       Play is a subscription service that will automatically renew for AED 3.25/Daily for Etisalat subscribers until you unsubscribe. You can unsubscribe from the service at anytime, by sending C HP1 to 1111.
